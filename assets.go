...
func (a *Assets) Generate(dirname string, ignoreRegexp *regexp.Regexp) ([]*bundler.ProcessedFile, error) {
	...
	if err = ioutil.WriteFile(dirname+manifest, buff.Bytes(), 0644); err != nil {
		return nil, err
	}
